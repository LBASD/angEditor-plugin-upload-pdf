...
export type IUploadConfigForPDF = IUploadConfig & {
...
export function getUploadPDFMenuConfig(): IUploadConfigForPDF {
  return {
    server: '', // server API 地址，需用户配置
    fieldName: 'wangeditor-uploaded-pdf', // formData 中，文件的 key
